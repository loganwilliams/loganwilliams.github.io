 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zA(t,e,n=!1){const{auth:r}=t;if(Gt(r.app))return Promise.reject(Sr(r));const s="reauthenticate";try{const i=await yi(t,Pg(r,s,e,t),n);_e(i.idToken,r,"internal-error");const a=Xl(i.idToken);_e(a,r,"internal-error");const{sub:c}=a;return _e(t.uid===c,r,"user-mismatch"),ds._forOperation(t,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&fn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
